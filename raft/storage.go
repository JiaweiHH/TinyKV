...
// to retrieve log entries from storage.（Storage 是用来存 storage 中检索 log entries 的）
//
...
type Storage interface {
	...
	// 传入日志索引 i，返回这条日志的任期号，i 的范围需要在 [first_index - 1, last_index]
	...
	// snapshot and call Snapshot later.（返回最近的快照）
